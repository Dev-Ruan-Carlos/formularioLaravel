                ...
                <div class="fundoazul" id="fundoazul">
                    ...
                    <div class="flex-jc white">
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox1" name="checkbox1" value="Ótimo - ★★★★★" type='radio'/>
                            <label for="checkbox1 white">Ótimo - ★★★★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox1" name="checkbox1" value="Bom - ★★★★" type='radio'/>
                            <label for="checkbox1 white">Bom - ★★★★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox1" name="checkbox1" value="Neutro - ★★★" type='radio' checked/>
                            <label for="checkbox1 white">Neutro - ★★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox1" name="checkbox1" value="Ruim - ★★" type='radio'/>
                            <label for="checkbox1 white">Ruim - ★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox1" name="checkbox1" value="Péssimo - ★" type='radio'/>
                            <label for="checkbox1 white">Péssimo - ★</label>
                        </div> 
                    </div>
                    <div class="white flex-jc m-1">
                    ...
                    <div class="flex-jc white">
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox2" name="checkbox2" value="Ótimo - ★★★★★" type='radio'/>
                            <label for="checkbox2 white">Ótimo - ★★★★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox2" name="checkbox2" value="Bom - ★★★★" type='radio'/>
                            <label for="checkbox2 white">Bom - ★★★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox2" name="checkbox2" value="Neutro - ★★★" type='radio' checked/>
                            <label for="checkbox2 white">Neutro - ★★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox2" name="checkbox2" value="Ruim - ★★" type='radio'/>
                            <label for="checkbox2 white">Ruim - ★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox2" name="checkbox2" value="Péssimo - ★" type='radio'/>
                            <label for="checkbox2 white">Péssimo - ★</label>
                        </div> 
                    </div>
                    <div class="white flex-jc m-1">
                    ...
                    <div class="flex-jc white">
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox3" name="checkbox3" value="Ótimo - ★★★★★" type='radio'/>
                            <label for="checkbox3 white">Ótimo - ★★★★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox3" name="checkbox3" value="Bom - ★★★★" type='radio'/>
                            <label for="checkbox3 white">Bom - ★★★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox3" name="checkbox3" value="Neutro - ★★★" type='radio' checked/>
                            <label for="checkbox3 white">Neutro - ★★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox3" name="checkbox3" value="Ruim - ★★" type='radio'/>
                            <label for="checkbox3 white">Ruim - ★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox3" name="checkbox3" value="Péssimo - ★" type='radio'/>
                            <label for="checkbox3 white">Péssimo - ★</label>
                        </div> 
                    </div>
                    <div class="white flex-jc m-1">
                    ...
                    <div class="flex-jc white">
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox4" name="checkbox4" value="Ótimo - ★★★★★" type='radio'/>
                            <label for="checkbox4 white">Ótimo - ★★★★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox4" name="checkbox4" value="Bom - ★★★★" type='radio'/>
                            <label for="checkbox4 white">Bom - ★★★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox4" name="checkbox4" value="Neutro - ★★★" type='radio' checked/>
                            <label for="checkbox4 white">Neutro - ★★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox4" name="checkbox4" value="Ruim - ★★" type='radio'/>
                            <label for="checkbox4 white">Ruim - ★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox4" name="checkbox4" value="Péssimo - ★" type='radio'/>
                            <label for="checkbox4 white">Péssimo - ★</label>
                        </div>
                    </div>
                    <div class="white flex-jc m-1">
                    ...
                    <div class="flex-jc white">
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox5" name="checkbox5" value="Ótimo - ★★★★★" type='radio'/>
                            <label for="checkbox5 white">Ótimo - ★★★★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox5" name="checkbox5" value="Bom - ★★★★" type='radio'/>
                            <label for="checkbox5 white">Bom - ★★★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox5" name="checkbox5" value="Neutro - ★★★" type='radio' checked/>
                            <label for="checkbox5 white">Neutro - ★★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox5" name="checkbox5" value="Ruim - ★★" type='radio'/>
                            <label for="checkbox5 white">Ruim - ★★</label>
                        </div> 
                        <div class="form-group white mr-05">
                            <input class="checkbox white" id="checkbox5" name="checkbox5" value="Péssimo - ★" type='radio'/>
                            <label for="checkbox5 white">Péssimo - ★</label>
                        </div>
                    </div>
                    <div class="white flex-jc m-1">
